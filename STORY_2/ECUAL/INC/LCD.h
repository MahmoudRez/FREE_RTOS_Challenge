...
extern void LCD_init(void);extern void LCD_DataWr(uint8_t Data);extern void LCD_displayString(uint8_t *COPY_ptrString);extern void LCD_gotoRowColumn( uint8_t COPY_u8Row , uint8_t COPY_u8Column);
extern void LCD_displayStringRowColumn(uint8_t *COPY_ptrString,uint8_t COPY_Row,uint8_t COPY_Column);extern void LCD_NUM_DISP(uint8_t COPY_u8Row , uint8_t COPY_u8Column, uint16_t COPY_u16num);
