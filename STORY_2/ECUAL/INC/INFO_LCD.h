...
typedef enum {LCD_UNINTAILIZED , LCD_INITALIZED}Enum_LCDInitState;

extern Enum_LCDInitState LCD_init(void);
extern Enum_LCDState LCD_sendCommand(uint8_t COPY_CMND);extern Enum_LCDState LCD_DataWr(uint8_t COPY_Data);
extern Enum_LCDState LCD_DispChar(uint8_t COPY_Data);extern Enum_LCDState LCD_displayString(uint8_t *COPY_ptrString);extern Enum_LCDState LCD_gotoRowColumn( uint8_t COPY_u8Row , uint8_t COPY_u8Column);
extern Enum_LCDState LCD_displayStringRowColumn(uint8_t *COPY_ptrString,uint8_t COPY_Row,uint8_t COPY_Column);extern void LCD_NUM_DISP(uint8_t COPY_u8Row , uint8_t COPY_u8Column, uint16_t COPY_u16num);
extern Enum_LCDState LCD_Clear(void);
extern Enum_LCDState LCD_VidDrawPattern(uint8_t COPY_u8Row,uint8_t COPY_u8Col,uint8_t* COPY_pu8DrawPattern,uint8_t COPY_u8Size);
